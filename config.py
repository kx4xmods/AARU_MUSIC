...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ixastamusicbot/AARU_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Unclenetwork")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Unclenetwork")
